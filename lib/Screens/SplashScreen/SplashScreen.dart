...
import '../../Models/NewModels/UserModel.dart';
      ...
      Future.delayed(
        ...
        () async {
          if (userId == null) {
            ...
            print(Provider.of<UserProvider>(context, listen: false).user.data!.userProfile );
            print(
                'User role in splash screen update ${Provider.of<UserProvider>(context, listen: false).user.role}');
            print(
                'User role in splash screen update ${Provider.of<UserProvider>(context, listen: false).role}');
