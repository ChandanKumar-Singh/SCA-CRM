                  ...
                  Expanded(
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        var time = ip.TodayInter[index].scheduleTime.toString();
                        var name =
                            ip.TodayInter[index].leads[0].customername ?? '';
                        var id = ip.TodayInter[index].id.toString();
                        var leadId = ip.TodayInter[index].leads[0].applicationId
                            .toString();
                        var followupStatus =
                        ...
                        var phone =
                            ip.TodayInter[index].leads[0].customerAddMobile ?? '';
