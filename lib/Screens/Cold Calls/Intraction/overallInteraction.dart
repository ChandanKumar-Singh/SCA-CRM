                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return InteractionsTile(
                            name:
                                ip.OverAllData[index].leads[0].customername??'',
                            applicationId: ip.OverAllData[index].leads[0].applicationId.toString(),
                            date: date,
                            time: time,
                            color: color,
                            followupStatus:
                            ...
                            phone:
                                ip.OverAllData[index].leads[0].customerAddMobile??'',
