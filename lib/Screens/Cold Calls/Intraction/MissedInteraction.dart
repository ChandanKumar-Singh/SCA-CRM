          ...
          controller: ip.controller,
                      ...
                      itemBuilder: (context, index) {
                        ...
                        var time = ip.InteractionData[index].scheduleTime
                            .toString();
                        var name = ip.InteractionData[index].leads[0].customername
                            .toString();
                        var id = ip.InteractionData[index].id.toString();
                        var applicationId =
                            ip.InteractionData[index].leads[0].applicationId.toString();
                        var followupStatus =
                        ...
                        var phone = ip.InteractionData[index].leads[0].customerAddMobile
                            ;
