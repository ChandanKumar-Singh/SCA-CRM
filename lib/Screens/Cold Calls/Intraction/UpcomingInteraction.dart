                      ...
                      Expanded(
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            var name = ip.UpcomingInter[index].leads[0].customername??'';
                            var id = ip.UpcomingInter[index].id.toString();
                            var leadId =
                                ip.UpcomingInter[index].leads[0].applicationId.toString();
                            var followupStatus =
                            ...
                            var phone = ip.UpcomingInter[index].leads[0].customerAddMobile??'';
