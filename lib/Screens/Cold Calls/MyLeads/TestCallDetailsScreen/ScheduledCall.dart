...
class ScheduledCall extends StatefulWidget {
  const ScheduledCall({Key? key,required this.leadId})
      : super(key: key);
    ...
    return Scaffold(
      ...
      body: Consumer<LeadsProvider>(
        builder: (context, lp, child) {
          debugPrint(lp.LeadsUserHistory.length.toString());
          debugPrint('Scheduled call ---> ${lp.IsLoading.toString()}');
          return Stack(
            children: [
              ListView.builder(
                  itemCount: lp.LeadsUserHistory.length,
                  itemBuilder: (context, index) {
                    return Padding(
                      padding: EdgeInsets.only(
                          ...
                          right: 20.0,
                          top: 15,
                          bottom: index == lp.LeadsUserHistory.length - 1
                              ? 50
                              : 0),
                      child: Container(
                        // height: 100,
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    lp.LeadsUserHistory[index].comment ==
                                            null
                                        ? const Text(
                                          'Comment :   ---',
