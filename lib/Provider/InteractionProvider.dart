...
class InteractionProvider with ChangeNotifier {
  ...
  Future<void> getInteraction(String authToken) async {
    ...
    bool isCacheExist =
        await APICacheManager().isAPICacheKeyExist('getInteraction');
    ...
    if (connectivityResult != ConnectivityResult.none) {
      ...
      try {
        ...
        if (response.statusCode == 200) {
          var cacheModel = await APICacheDBModel(
              key: 'getInteraction', syncData: response.body);
            ...
            if (success == 200) {
              ...
              for (var v in data) {
                ...
                if (ymdDate(v['schedule_date'])
                  ...
                  _interactionData.sort(
                      (a, b) => b.scheduleDate!.compareTo(a.scheduleDate!));
                  notifyListeners();
                }
      ...
      notifyListeners();
      if (isCacheExist) {
        var cacheData = await APICacheManager().getCacheData('getInteraction');
