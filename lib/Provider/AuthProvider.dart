        ...
        if (responseData['success'] == 200) {
          ...
          try {
            Provider.of<UserProvider>(context, listen: false).role =
                result['role'];
            print(
                '00000000000000000       0000000000 {}   0000000000000000000 ');

            Provider.of<UserProvider>(context, listen: false)
                .setUser(UserModel.fromJson(responseData['results']));
            var data = result['data'];
            print(
                '00000000000000000       0000000000 ${data['id']}   0000000000000000000 ');
            _token = result['token'];
            ...
            print(
                '00000000000000000       00000000000000000000000000000 $_userId');
            ...
            prefs.setInt('permissionMenu', data['permission_menu']);

            prefs.setInt('permissionForCl', data['permission_for_cl']);

            prefs.setString('user',
                jsonEncode(UserModel.fromJson(responseData['results'])));
            notifyListeners();
          } catch (e) {
            print(e);
          }
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (responseData['success'] == 200) {
          ...
          prefs.setString('dob', responseData['data']['dob']);
          if (password != '') {
            prefs.setString('password', password);
          }
          ...
          await login(prefs.getString('email')!, prefs.getString('password')!,
              prefs.getString(Const.FCM_TOKEN)!, context);
