...
class LeadsModel {
  ...
  factory LeadsModel.fromJson(Map<String, dynamic> json) => LeadsModel(
    ...
    count: json["count"],
    data: List<LeadInfo>.from(json["data"].map((x) => LeadInfo.fromJson(x))),
...
//    // property:  Property.fromJson(json["property"]),
    ...
    agents:  json["agents"]!=null?List<Agent>.from(json["agents"].map((x) => Agent.fromJson(x))):null,
...
class LeadInfo {
  ...
  factory LeadInfo.fromJson(Map<String, dynamic> json) => LeadInfo(
    id: json["id"],
    leadId: json["lead_id"],
    userId: json["user_id"],
